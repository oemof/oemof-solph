...
General description
-------------------
The goal of GasBus and GasLine is to implement a piecewise linear model. The gas flow is the result of a pressure difference and has a non-linear relationship.
