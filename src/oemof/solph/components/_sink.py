...
class Sink(Node):
    ...
    def __init__(self, label=None, *, inputs, parent_node=None, custom_properties=None):
        if inputs is None:
            inputs = {}
        ...
        super().__init__(
            label=label, inputs=inputs, parent_node=parent_node, custom_properties=custom_properties
        )
