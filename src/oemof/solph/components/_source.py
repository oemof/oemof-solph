...
class Source(Node):
    ...
    def __init__(self, label=None, *, outputs, parent_node=None, custom_properties=None):
        if outputs is None:
            outputs = {}
        ...
        super().__init__(
            label=label, outputs=outputs, parent_node=parent_node, custom_properties=custom_properties
        )
