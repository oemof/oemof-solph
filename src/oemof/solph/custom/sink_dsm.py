...
class SinkDSMOemofInvestmentBlock(SimpleBlock):
    ...
    * Variable costs:
    ...
    See remarks in :class:`~oemof.solph.custom.sink_dsm.SinkDSMOemofBlock`.

    **Symbols and attribute names of variables and parameters**

    * Please refer to :class:`~oemof.solph.custom.sink_dsm.SinkDSMOemofBlock`
...
class SinkDSMDIWInvestmentBlock(SimpleBlock):
    ...
    * Please refer to :class:`~oemof.solph.custom.sink_dsm.SinkDSMDIWBlock`
      for a variables and parameter description.
    * The following variables and parameters are exclusively used for
      investment modeling:
...
class SinkDSMDLRInvestmentBlock(SimpleBlock):
    ...
    * Please refer to :class:`~oemof.solph.custom.sink_dsm.SinkDSMDLRBlock`.
    * The following variables and parameters are exclusively used for
      investment modeling:
