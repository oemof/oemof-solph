...
class GenericCAESMultiPeriodBlock(SimpleBlock):
    r"""Block for nodes of class:`.GenericCAES` with :attr:`multiperiod`
    set to True.

    See class:`GenericCAESBlock` for constraints formulations.
    """
