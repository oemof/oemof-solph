...
class InvestmentFlow(Flow):
    ...
    For the investment parameters, see :class:`oemof.solph._options.Investment`

    For the flow parameters, see :class:`oemof.solph.flows._flow.Flow`

    For the variables, constraints and parts of the objective function,
    that are created,
