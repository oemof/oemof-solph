...
class Feed(object):
    ...
    #init for basic data
    def __init__(self, DIC, site, year, region, params):
        """
        Timeseries-Class
        ...
        self._load_timeseries(DIC, site, year, region, params)


    def _load_timeseries(self, DIC, site, year, region, params):
        """
        ...
        if (self._weatherObject is None) or (params.get("recalculate") is not None):
            self._weatherObject = self._get_weather_object_from_source(self._DIC, self._site, self._year, self._region, params)
        if (self._timeseries is None) or (params.get("recalculate") is not None):
            self._apply_model(DIC, site, year, region, self._weatherObject)
    ...
    def _get_weather_object_from_source(self, DIC, site, year, region, params):
        ...
        obj = w.Weather(year, region, params)
        obj.get_raw_data(DIC, site, year, region)
