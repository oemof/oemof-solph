 ...
 * Create a structure to use examples as system tests (`issue #160 <https://github.com/oemof/oemof-solph/issues/160>`_)
 ...
 * Examples executable from command-line (`issue #227 <https://github.com/oemof/oemof-solph/issues/227>`_)
