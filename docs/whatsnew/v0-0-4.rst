...
* Add postheating device to transport energy between two buses with different temperature levels (`issue #97 <https://github.com/oemof/oemof-solph/issues/97>`_)
