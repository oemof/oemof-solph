 ...
 * Add a time-depended upper bound for the output of a component (`issue #65 <https://github.com/oemof/oemof-solph/issues/65>`_)
 ...
 * Tests added to test constraints and the registration process (`issue #73 <https://github.com/oemof/oemof-solph/issues/73>`_).
