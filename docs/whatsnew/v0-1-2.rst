...
* Revise examples - clearer naming, cleaner code, all examples work with cbc solver (`issue #238 <https://github.com/oemof/oemof-solph/issues/238>`_, `issue #247 <https://github.com/oemof/oemof-solph/issues/247>`_).
* Add option to choose solver when executing the examples (`issue #247 <https://github.com/oemof/oemof-solph/issues/247>`_).
